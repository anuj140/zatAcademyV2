...
This code of `let a = 10 `

<mark>Below block of code in Js</mark>
...
- [ ] Uncheck task
- [x] Check task 
- [ ] another uncheck task
- [x] another check task